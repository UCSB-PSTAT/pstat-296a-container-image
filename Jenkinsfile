            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"actuar\");library(\"DataCombine\");library(\"fitdistrplus\");library(\"readxl\");library(\"rmarkdown\")"'
